...
@section('content_header')
    ...
    <a class="btn" style="margin-left: 910px; background-color: rgb(190, 131, 21); color: white;" href="{{ route('tipovehiculo_create') }}">Nuevo <i class="fas fa-plus"></i></a>
@stop
            ...
            <tbody>
                @foreach ($vehiculo as $vehiculos)
                    <tr>
                        ...
                        <td><a class="btn" style="background-color: rgb(190, 131, 21); color: white;" title="Editar" href="{{ route('tipovehiculo_edit', ['id' => $vehiculos->id]) }}"><i class="fas fa-edit"></i></a></td>
                    </tr>
                @endforeach
            </tbody>
    </table>
