    ...
    <form action="{{ route('servicio_store') }}" method="post" enctype="multipart/form-data">
        ...
        <div style="margin: 3%;">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="txtNomServicio" name="txtNomServicio" placeholder="Escribe el nombre del servicio">
            </div>
            <div class="mb-3">
                <label for="txtDescripcionServicio" class="form-label">Descripcion del Servicio</label>
                <textarea class="form-control" id="txtDescripcionServicio" name="txtDescripcionServicio" maxlength="500" rows="3"></textarea>
            </div>
            <div class="mb-3">
